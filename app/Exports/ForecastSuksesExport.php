...
class ForecastSuksesExport implements
    FromArray,
    WithColumnWidths,
    WithTitle,
    WithStyles
{
    ...
    public function array(): array
    {
        ...
        $data[] = [!empty($filterInfo) ? 'Filter: ' . implode(' | ', $filterInfo) : 'Filter: Semua Data Forecast Sukses', '', '', '', '', '', '', '', ''];
    ...
    /**
     * Get forecast data based on filters (sama seperti getForecastsByStatus('sukses') di controller, tanpa pagination)
     */
