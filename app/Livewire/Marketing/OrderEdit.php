...
class OrderEdit extends OrderCreate
{
    public function mount(?Order $order = null): void
    {
        ...
        // Load order data
        $this->tanggalOrder = $order->tanggal_order ? Carbon::parse($order->tanggal_order)->format('Y-m-d') : $this->tanggalOrder;
        $this->poNumber = $order->po_number;
        $this->poStartDate = $order->po_start_date ? Carbon::parse($order->po_start_date)->format('Y-m-d') : $this->poStartDate;
        $this->poEndDate = $order->po_end_date ? Carbon::parse($order->po_end_date)->format('Y-m-d') : $this->poEndDate;
