...
function showSuccessModal(type, message, description = '', additionalInfo = '', autoClose = true) {
    ...
    switch (type) {
        case 'create':
        case 'tambah':
            title.textContent = 'Berhasil Dibuat';
            subtitle.textContent = 'Data baru telah ditambahkan';
            messageEl.textContent = message || 'Data berhasil dibuat!';
            descriptionEl.textContent = description || 'Data baru telah disimpan ke sistem.';
            break;
        case 'forecast':
            title.textContent = 'Forecast Berhasil Dibuat';
            subtitle.textContent = 'Forecasting telah berhasil diproses';
            messageEl.textContent = message || 'Forecast berhasil dibuat!';
            descriptionEl.textContent = description || 'Data forecast telah disimpan ke sistem.';
            break;
        case 'edit':
        case 'update':
            title.textContent = 'Berhasil Diperbarui';
            subtitle.textContent = 'Perubahan telah disimpan';
            messageEl.textContent = message || 'Data berhasil diperbarui!';
            descriptionEl.textContent = description || 'Semua perubahan telah disimpan ke sistem.';
            break;
        case 'delete':
        case 'hapus':
            title.textContent = 'Berhasil Dihapus';
            subtitle.textContent = 'Data telah dihapus';
            messageEl.textContent = message || 'Data berhasil dihapus!';
            descriptionEl.textContent = description || 'Data telah dihapus dari sistem.';
            break;
        default:
