                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                type="text"
                                id="jumlah_piutang_display_edit"
                                value="{{ number_format($jumlah_piutang ?? 0, 0, ',', '.') }}"
                                ...
                                oninput="formatCurrencyInput(this, 'jumlah_piutang_hidden_edit')"
                                onblur="syncToLivewire('jumlah_piutang_hidden_edit')"
                            >
                        </div>
                        <input type="hidden" wire:model.defer="jumlah_piutang" id="jumlah_piutang_hidden_edit" value="{{ $jumlah_piutang ?? 0 }}">
