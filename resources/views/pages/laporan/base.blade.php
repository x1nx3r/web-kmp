    ...
    <div class="px-4 sm:px-6 py-4">
        ...
        <div class="sm:hidden">
            ...
            <select id="tabs" name="tabs"
                ...
                <option value="{{ route('laporan.evaluasiProcurement') }}" {{ $activeTab === 'evaluasiProcurement' ? 'selected' : '' }}>
        ...
        <nav class="hidden sm:flex sm:space-x-8" aria-label="Tabs">
            ...
            <a href="{{ route('laporan.evaluasiProcurement') }}"
               class="{{ $activeTab === 'evaluasiProcurement' ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                Evaluasi Procurement
            </a>
