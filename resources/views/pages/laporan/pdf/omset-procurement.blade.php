...
<head>
    <meta charset="utf-8">
    <title>Laporan Omset Procurement</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h2>Laporan Omset Procurement</h2>
        <p>
    ...
    @foreach($groupedData as $purchasingNama => $details)
        <div class="procurement-header">
            <strong>Procurement: {{ $purchasingNama }}</strong>
        ...
        <table>
            ...
            <tbody>
                ...
                @endforeach
                <tr class="total-row">
                    <td colspan="3" style="text-align: right;"><strong>Subtotal {{ $purchasingNama }}:</strong></td>
