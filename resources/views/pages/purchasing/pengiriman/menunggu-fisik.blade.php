                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="text-right">
                                ...
                                @endphp
                                @if($totalHarga > 0)
                                    <p class="text-sm font-semibold text-purple-600">Rp {{ number_format($totalHarga, 3, ',', '.') }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                                                ...
                                                @if($qtyToShow && $qtyToShow > 0)
                                                    <span class="flex flex-col gap-0.5">
                                                        <span class="flex items-center gap-1">
                                                            ...
                                                            <span class="font-medium">{{ number_format($qtyToShow, 3, ',', '.') }} kg</span>
                                                        </span>
                                                ...
                                                @if($amountToShow && $amountToShow > 0)
                                                    <span class="flex flex-col gap-0.5">
                                                        <span class="flex items-center gap-1 font-medium text-green-700">
                                                            ...
                                                            <span>Rp {{ number_format($amountToShow, 3, ',', '.') }}</span>
                                                        </span>
