...
Route::middleware(['auth'])->group(function () {
    ...
    // Procurement routes - purchasing functionality
    Route::prefix('procurement')->group(function () {
        ...
        // Pengiriman routes - place specific routes before resource
    ...
    // Marketing routes - restricted to marketing and direktur roles
    Route::middleware(['role:marketing|direktur'])->group(function () {
        // Klien listing page (Livewire)
        ...
        // Order routes (resource) and helper endpoints
        ...
        // Penawaran editing route (example)
